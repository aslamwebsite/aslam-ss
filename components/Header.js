            ...
            <div className='row'>
              <div className='col-12 float-start flex-center'>
                ...
                <div className='col-lg-4'>
                  <div className='text-center col-12 float-start text-white'> <a><Enquiry enquireText="Enquire" requestCallbackText="Request a Call Back" /></a>
</div>
                </div>
                <div className='col-lg-4'>
                  <div className="menustn d-flex justify-content-end align-items-center">
                    <div className='categories d-flex'>
                      ...
                      <li><Link href='/projects/homes'>HOMES</Link></li>
                        <li><Link href='/projects/retail'>RETAIL</Link></li>
                        <li><Link href='/projects/offices'>OFFICE</Link></li>
                      </ul>
                    </div>
                    <Navbar />
                  </div>
